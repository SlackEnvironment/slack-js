...
describe("transaction.js", function () {
  ...
  var transaction = slack.transaction;
  ...
  describe("#createTransaction", function () {
    ...
    describe("returned transaction", function () {
      ...
      it("should be signed correctly", function () {
        var result = slack.crypto.verify(trs);
        result.should.equal(true);
      });

      it("should be deserialised correctly", function () {
        var deserialisedTx = slack.crypto.fromBytes(slack.crypto.getBytes(trs).toString("hex"));
  ...
  describe("createTransaction and try to tamper signature", function(){
    ...
    it("should not validate overflown signatures", function(){
      ...
      var old_transaction = slack.transaction.createTransaction('AacRfTLtxAkR3Mind1XdPCddj1uDkHtwzD', 1, null, 'randomstring');
      ...
      */
      ...
      // console.log("TXID " + slack.crypto.getId(old_transaction));
      // console.log("VERIFY " + slack.crypto.verify(old_transaction));
      // console.log("SIG " + old_transaction.signature + "\n");

      slack.crypto.verify(old_transaction).should.equal(true);
      ...
      slack.crypto.verify(old_transaction).should.equal(false);
  ...
  describe("#createTransaction with second secret", function () {
    ...
    var keys = slack.crypto.getKeys(secondSecret);
    ...
    describe("returned transaction", function () {
      ...
      it("should be second signed correctly", function () {
        var result = slack.crypto.verifySecondSignature(trs, keys.publicKey);
        (result).should.equal(true);
      });
